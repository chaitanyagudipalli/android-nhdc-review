...
public class SupplierActivity extends DashboardAppCompatActivity
{
...
protected void onCreate(Bundle savedInstanceState) 
{
	...
	setContentChildView(R.layout.activity_supplier);
	...
	public boolean onOptionsItemSelected(MenuItem item){
		...
		switch (item.getItemId()) {
			case R.id.action_refresh:
				...
				SupplierListFragment listFragment = (SupplierListFragment) fm.findFragmentById(R.id.facility_list_fragment);
				listFragment.syncSuppliers(item);
				return true;
