...
public class TranporterActivity extends DashboardAppCompatActivity
{
...
protected void onCreate(Bundle savedInstanceState) 
{
	...
	setContentChildView(R.layout.transporter_layout);
	...
	public boolean onOptionsItemSelected(MenuItem item){
		...
		switch (item.getItemId()) {
			case R.id.action_refresh:
				...
				TransporterListFragment facilityListFragment = (TransporterListFragment) fm.findFragmentById(R.id.facility_list_fragment);
				facilityListFragment.syncTransporters(item);
				return true;
